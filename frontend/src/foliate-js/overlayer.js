...
export class Overlayer {
    ...
    constructor(doc) {
        ...
        this.#svg.style.setProperty('position', 'absolute', 'important')
        this.#svg.style.setProperty('top', '0', 'important')
        this.#svg.style.setProperty('left', '0', 'important')
        this.#svg.style.setProperty('width', '100%', 'important')
        this.#svg.style.setProperty('height', '100%', 'important')
        this.#svg.style.setProperty('pointer-events', 'none', 'important')
        this.#svg.style.setProperty('z-index', '10', 'important')
    ...
    add(key, range, draw, options) {
        ...
        console.log("[FoliateView debug] Overlayer.add called:", { key, rects, elementMarkup: element?.outerHTML });
