  ...
  return (
    ...
    >
      <div
        ...
        className="w-full max-w-sm rounded-2xl border border-app-border bg-app-elevated shadow-xl overflow-hidden"
      ...
      >
        ...
        <div className="px-4 py-3 border-t border-app-border flex items-center justify-end gap-2">
          <button
            type="button"
            onClick={onClose}
            className="px-3.5 py-1.5 rounded-full text-xs font-medium border border-app-border bg-app-surface text-tx-primary hover:bg-app-hover"
          >
            取消
          </button>
          <button
            ...
            className={cn(
              "px-4 py-1.5 rounded-full text-xs font-bold flex items-center gap-1.5 transition-opacity",
