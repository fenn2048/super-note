        ...
        >
          ...
          >
            ...
            <p className="text-sm text-zinc-500 dark:text-zinc-400 text-center mt-1.5">
              下次打开 Love Write 时使用 <strong className="font-medium text-zinc-700 dark:text-zinc-200">{featureLabel}</strong> 即可登录 <strong className="font-medium text-zinc-700 dark:text-zinc-200">{username || "当前账号"}</strong>，无需再输入密码。
            </p>
