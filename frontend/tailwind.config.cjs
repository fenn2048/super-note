  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'sys-title-lg': 'var(--font-size-title-lg)',
        'sys-title-md': 'var(--font-size-title-md)',
        'sys-title-sm': 'var(--font-size-title-sm)',
        'sys-body-lg': 'var(--font-size-body-lg)',
        'sys-body-md': 'var(--font-size-body-md)',
        'sys-body-sm': 'var(--font-size-body-sm)',
        'sys-label-lg': 'var(--font-size-label-lg)',
        'sys-label-md': 'var(--font-size-label-md)',
        'sys-label-sm': 'var(--font-size-label-sm)',
      },
      fontFamily: {
