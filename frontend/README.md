...
super-note 是一款自托管的私有化笔记应用，采用现代前后端分离架构，支持 Docker 一键部署。集成 Tiptap 富文本编辑器、AI 智能写作助手、思维导图、任务管理等功能，打造一体化知识管理平台。
...
| 服务 | 镜像 | 端口 | 说明 |
|------|------|------|------|
| super-note | 自构建 | 3001 | 主应用（前后端一体 + SQLite） |
...
super-note is a self-hosted private note-taking application with a modern frontend-backend separated architecture. It supports one-click Docker deployment, featuring a Tiptap rich-text editor, AI-powered writing assistant, mind mapping, task management, and more — an all-in-one knowledge management platform.
...
|---------|-------|------|-------------|
| super-note | Self-built | 3001 | Main app (frontend + backend + SQLite) |
